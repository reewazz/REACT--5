...
useEffect(()=> {
  ...
  const handleSubmit = async ()=> {
    const response = axios.post ("http://localhost:5000/blog/create",formData)
  ...
  return (
    <div className="flex items-center flex-col">
      <div className=" flex flex-col gap-2">
        ...
        <input type="text" name="title" id="title" value={formData.title}  onChange={(e)=>handleChange(e)} className="bg-gray-200 p-4  border-2" />
      </div>
      <div className=" flex flex-col gap-2">
